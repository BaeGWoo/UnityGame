...
public class Sparrow : MonoBehaviour, AnimalInterface
{
    ...
    private void Awake()
    {
        moveDirection[0] = new Vector3(-2.6f, 0, 6);
        moveDirection[1] = new Vector3(-5.2f, 0, 3f);
        moveDirection[2] = new Vector3(2.6f, 0, 6);
        moveDirection[3] = new Vector3(5.2f, 0, 3f);
        moveDirection[4] = new Vector3(-5.2f, 0, -3);
        moveDirection[5] = new Vector3(-2.6f, 0, -6);
        moveDirection[6] = new Vector3(2.6f, 0, -6);
        moveDirection[7] = new Vector3(5.2f, 0, -3);
